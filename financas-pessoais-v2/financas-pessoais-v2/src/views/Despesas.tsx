...
export default function Despesas() {
  const { cur, expenses, removeExpense, openModal, categories, filterCat, setFilterCat } = useApp();
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 14, marginBottom: 20 }}>
        <div className="card">
          ...
          <div style={{ fontSize: 12.5, color: 'var(--ink3)', marginTop: 4 }}>sem cartões · ver aba Cartões</div>
        </div>
        <div className="card">
